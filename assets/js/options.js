...
var awd_countdownDate = '2016/04/01 00:00:00'; // 2015-12-10
...
var awd_contactEmail = 'richard.fugisse@gmail.com.br'; // contact email address
var awd_contactSuccess = '<i class="icons fa fa-check valid"></i> Sua mensagem foi enviada com sucesso'; // success submit message
var awd_contactInputError = '<i class="icons fa fa-close error"></i> todos os campos são necessários'; // input error message
var awd_contactEmailError = '<i class="icons fa fa-close error"></i> endereço de e-mail inválido'; // email error message
